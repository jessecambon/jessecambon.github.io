...
Let's take a look at the 'us_rent_income' dataset from the [tidyr](https://tidyr.tidyverse.org) package:
...
* Atleast one geom function such as geom_histogram, geom_point, or geom_line is included which defines what the graph will look like.
* The theme of the chart can be modified using preset themes such as theme_bw and theme_classic and further customized using the theme function.
...
Lollipop charts can be an attractive alternative to bar charts. coord_flip is used to orient the chart horizontally instead of vertically.
