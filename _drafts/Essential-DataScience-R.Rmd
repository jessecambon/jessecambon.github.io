...
Since these two datasets we just created, mpg1 and mpg2, have the same columns we can stack them vertically using [bind_rows](https://dplyr.tidyverse.org/reference/bind.html):
