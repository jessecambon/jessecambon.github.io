...
1. comment out `source(here::here("rmd_config.R"))`
2. Run with `output: html_document`
   (this generates the HTML content for the leaflet map that we need)
3. uncomment source() line from step 1
4. Run with this output statement
...
3. Find the Leaflet html content <div>...</div><script>...</script> content and paste it into the .md file.
